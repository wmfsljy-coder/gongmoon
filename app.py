...
2. **'관련' 항목 유연성**: 원본 문서에 '관련(근거)' 내용이 없다면 [이유]에 관련 문서가 누락되었다는 표시를 하고, '1. 관련: 웅천고등학교-0000(2026. 5. 13.) "관련문서 제목"'과 같은 유형을 만들고, 본문 주제를 '2.'로 시작하십시오. (이 경우 세부 내역은 '가., 나., 다.'로 이어집니다.)
