...
5. **들여쓰기 및 마감**: 2단계(가.): 2칸 공백 / 3단계(1)): 4칸 공백. 본문 끝과 '붙임' 사이만 빈 줄 1개를 둡니다. 마지막 글자 뒤 2칸 띄우고 '끝.' 기재.
...
**[규정 4. 붙임(첨부물) 정렬 가이드]**
- 첨부 1개: '붙임' 글자 뒤에 스페이스바 2번을 누르고 파일명을 씁니다. (번호 '1.'은 생략)
- 첨부 2개 이상 (수직 정렬 필수):
  [첫째 줄] '붙임' + 스페이스바 2번 + '1. 파일명 1부.'
  [둘째 줄] 스페이스바 6번(      ) + '2. 파일명 1부.'
  ※ 경고: 2번 항목은 반드시 새로운 줄에서 시작하며, 맨 앞에 정확히 6칸의 공백이 있어야 합니다.
...
1. 관련: 기관명-0000(2026. 5. 13.) "관련문서 제목"
